...
export default function Productpromo({ src, alt, brand, desc1, desc2, price }: Productype) {
        ...
        <main className='font-semibold'>
            <div className='relative w-[610px] h-[388px] '>
                ...
                <section className='absolute bg-slate-900/40 p-8 pt-[px] left-14  z-10'>
                    ...
                    '>{price} </h1>
                        <button className='border-2 border-cyan-400 hover:border-cyan-700 hover:text-orange-500 px-5 py-2 rounded-3xl'>Shop Now</button>
