...
export default function Middlefooter() {
  const icons = [
    { src: "/assets/Icon/linkedin (1).png", alt: "LinkedIn" },
    { src: "/assets/Icon/facebook (1).png", alt: "Facebook" },
    { src: "/assets/Icon/pinterest3.png", alt: "Pinterest" },
    { src: "/assets/Icon/social2.png", alt: "WhatsApp" },
    { src: "/assets/Icon/twitter.png", alt: "Twitter" },
    { src: "/assets/Icon/email4.png", alt: "Email" },
  ];
  ...
  return (
    <main className="p-4 flex justify-between items-center text-black text-sm">
      ...
      <section className="space-y-2 bg-slate-500/50 p-10 py-8 rounded-2xl">
        ...
        <button className="border-2 py-3 px-8 rounded-3xl hover:text-white  hover:border-green-300">
          Create Account
        </button>
      </section>
    </main>
